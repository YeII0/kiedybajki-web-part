// Contain code execution for add_animesub page.
...
const titleOnSite = document.querySelector('#ansi_title');
const titleOnSiteError = document.querySelector('#ansi_title + .validation-error');
...
form.addEventListener('submit', async e =>
{
    ...
    if (isTitleValid && isTitleOnSiteValid && isAuthorValid && isCrNumberingDiffValid && isCrDiffTitleValid)
    {
