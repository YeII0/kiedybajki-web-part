// Contain code execution for edit animesub page.
...
main.addEventListener('submit', async e =>
{
    ...
    */
    if (e.target.matches('form[id^="form-anime-"]'))
    {
        ...
        const titleInSite = editedRow.querySelector('input[name="ansi_title"]');
        const titleInSiteError = editedRow.querySelector('input[name="ansi_title"] + .validation-error');
        ...
        if (isTitleInSiteValid && isAuthorValid && isCrNumberingDiffValid && isCrDiffTitleValid)
        {
